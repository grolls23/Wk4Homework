...
#I will use AFF_ISO over ISO because I only want to include sovereign states and not overseas territories like Aruba or American Samoa
country_borders <- country_borders %>%
  mutate(., "iso3" = countrycode(country_borders$AFF_ISO, origin = 'iso2c', destination = 'iso3c'))
